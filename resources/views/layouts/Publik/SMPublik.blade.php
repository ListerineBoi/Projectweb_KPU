	  ...
	  <img src="http://127.0.0.1:8000/image/logokpu.png" style="float:left; width:70px;height:70px;" />
        ...
        <h4 class="text-bold text-center"> ------- Asal TPS Pemilih ------- </h4>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" maxlength="16" onkeypress="return event.charCode >= 48 && event.charCode <=57" name="nokk" placeholder="Masukkan No KK">
				</div>
			</div>
			<div class="form-group row">
				<label class="control-label col-sm-2" for="nik">NIK * </label>
				<div class="col-sm-10">
					<input type="text" class="form-control" maxlength="16" name="nik" onkeypress="return event.charCode >= 48 && event.charCode <=57" placeholder="Masukkan NIK Sesuai KTP">
				</div>
			</div>
            <div class="form-group row">
